...
export const fetchCards = createAsyncThunk('cards/fetchCards', async (_obj, { getState }) => {
  ...
  const url = `/api/boards/${board.board._id}/cards`
  const response = await fetch(url).then(async (response) => await response.json())
...
export const deleteCard = createAsyncThunk(
  ...
  async (cardId: string, { getState }) => {
    ...
    const url = `/api/boards/${board.board._id}/cards/${cardId}`
...
export const addCard = createAsyncThunk('card/addCard', async (columnId: string, { getState }) => {
  ...
  const url = `/api/boards/${data.boardId}/columns/${columnId}/cards`
...
export const updateCard = createAsyncThunk(
  ...
  async (obj: CardPatch, { getState }) => {
    ...
    const url = `/api/boards/${board.board._id}/cards/${obj._id}`
...
export const updateCardSequence = createAsyncThunk(
  ...
  async (obj: CardPatch, { getState }) => {
    ...
    const url = `/api/boards/${board.board._id}/cards/${_id}`
