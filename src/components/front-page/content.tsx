...
const Part2 = (): JSX.Element => {
  return (
    <Box py='20vh' px={['5vh', '35vh']} color='white' fontSize='2em' bgColor='rgba(14, 16, 18)'>
      ...
      <Text fontSize={['0.75em']} mt='10vh'>In today's fast-paced world, organizations are increasingly adopting AI to streamline operations and improve decision-making. However, AI systems must be developed and <Text as='span' className=''>implemented with caution</Text>, ensuring that they do not compromise fundamental human rights or perpetuate bias and discrimination. Our tool provides a comprehensive assessment of your organization's AI implementation, <Text as='span' className=''>highlighting areas of strength and areas for improvement.</Text></Text>
      <Heading mt={['20vh', '10vh']} style={{ position: 'relative' }}>
        <Image src='/frontpage/arrow.png' alt='Demo image' className='fniWYQ' />
        <Text className='highlight pink' fontSize={['2em', '0.75em']}>Recommendations Report</Text>
      </Heading>
      <Text fontSize={['2em', '1em']} mt='10vh'>You will also receive detailed <Text as='span' className=''>suggestions and guidance</Text> for improving the trustworthiness of your AI system. This will enable you to build and maintain <Text as='span' className=''>trust</Text> with your customers, employees, and other stakeholders, and <Text as='span' className=''>mitigate the risks</Text> associated with AI implementation.</Text>
      <Heading mt={['20vh', '10vh']} className='highlight pink' fontSize={['2em', '1em']}>You are in control</Heading>
      <Text fontSize={['2em', '0.75em']} mt='5vh'>One of the key benefits of our <Text as='span' className=''>open-source</Text> tool is that it can be <Text as='span' className=''>hosted and fully controlled by your organization</Text>. This means that you can maintain complete ownership and control over your data and assessments.</Text>
      <Text fontSize={['2em', '0.75em']} mt='5vh'>Host the tool on your own servers, you can also ensure that the tool <Text as='span' className=''>meets your</Text> organization's specific <Text as='span' className=''>security and privacy requirements</Text>.</Text>
      <Text fontSize={['2em', '0.75em']} mt='5vh'>OPEN-SOURCE, modify and adapt the tool to fit your <Text as='span' className=''>organization's unique needs</Text>.</Text>
      <Text fontSize={['2em', '0.75em']} mt='5vh'>This flexibility and control make our tool an ideal solution for organizations looking to assess the trustworthiness of their AI systems while maintaining full control over their data and assessments.</Text>
      <Center mt='10vh'>
